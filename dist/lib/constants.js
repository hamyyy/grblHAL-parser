...
exports.grbl11PinMap = exports.controlPinMap = exports.limitPinMap = exports.statusMap = exports.subStateMessage = exports.statusStateTypes = exports.errorMap = exports.buildOptionsMap = exports.alarmMap = exports.supportedVersions = exports.gcodeMap = exports.settingsMap = void 0;
var gcode_map_1 = require("./data/gcode_map");
var setting_codes_1 = require("./data/setting_codes");
exports.settingsMap = setting_codes_1.settingCodes;
exports.gcodeMap = gcode_map_1.gcodeMap;
exports.supportedVersions = ['Grbl 1.1e', 'Grbl 1.1f'];
exports.alarmMap = {
...
exports.statusStateTypes = ["Idle", "Run", "Hold", "Jog", "Alarm", "Door", "Check", "Home", "Sleep", "Tool"];
exports.subStateMessage = {
    "Door": {
...
exports.controlPinMap = {
    0: "door",
    1: "hold",
    2: "soft-reset",
    3: "cycle-start",
};
exports.grbl11PinMap = {
    "X": "limit-x",
    "Y": "limit-y",
    "Z": "limit-z",
    "A": "limit-a",
